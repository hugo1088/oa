...
<form id="userBaseForm" method="post" action="user-avatar-crop.do" class="form-horizontal">
	...
	<div class="controls">
	  <div id="avatarImage">
	    <c:if test="${not empty userBase.avatar}">
		  <img src="user-base-avatar.do?id=${userBase.id}" style="width:512px;">
		</c:if>
	  </div>
	  <div id="avatarButton" class="btn btn-success fileinput-button">
		...
		<input type="file" name="avatar" class="fileupload"
		  ...
		  data-url="user-avatar-upload.do"
		  data-form-data='{"id":"${userBase.id}","imgId":"avatarImage","btnId":"avatarButton","viewUrl":"user-avatar-view.do?id="}'>
	  </div>
