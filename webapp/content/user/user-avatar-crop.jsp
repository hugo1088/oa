...
<form id="userBaseForm" method="post" action="user-avatar-save.do" class="form-horizontal">
  ...
  <div class="control-group">
	...
	<div class="controls">
	  <div id="avatarImage">
		<img id="target" src="user-base-avatar.do?id=${userBase.id}" style="width:${w}px;height:${h}px;">
	  </div>
    </div>
  </div>
